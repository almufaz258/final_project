...
class _RegScreenState extends State<RegScreen> {
  ...
  Widget build(BuildContext context) {
    if (_checkAuthorization()) {
      return Scaffold(
        appBar: myAppBar('Финальный проект'),
        ...
        body: Container(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                const SizedBox(width: 280, height: 180, child: Image(image: AssetImage('assets/dl2.jpg')),),
                Row(
                  children: const [
            ...
            child: Form(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(width: 90, height: 90, child: Image(image: AssetImage('assets/preview.png')),),
                          ...
                          if (_formKey.currentState!.validate()) {
                            ...
                            if (_checkAuthorization()) {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(content: Text('Ошибка доступа \n Неверные данные'), duration: Duration(seconds: 3)),
                              );
                            }
                          }
                         setState(() {});

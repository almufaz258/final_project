                          ...
                          child: ListTile(
                            title: Row(
                              children: [
                                Expanded(
                                    flex: 1,
                                    child: Text(snapshot.data!.items[index].id.toString(), style: Theme.of(context).textTheme.bodyText1,)
                                ),
                                Expanded(
                                    flex: 4,
                                    child: Text(snapshot.data!.items[index].name, style: Theme.of(context).textTheme.bodyText2,)
                                ),
                                Expanded(
                                    flex: 6,
                                    child: Text(snapshot.data!.items[index].email, style: Theme.of(context).textTheme.button, textAlign: TextAlign.right,)
                                ),
                              ],
                            ),
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                const SizedBox(width: 90, height: 90, child: Image(image: AssetImage('assets/dl2.jpg')),),
